...
import static org.onosproject.net.flow.FlowRuleOperation.Type.REMOVESPEFIC;
...
public class FlowRuleOperations {
    ...
    public static final class Builder {
        ...
        public Builder removeSpec(FlowRule flowRule) {
            currentStage.add(new FlowRuleOperation(flowRule, REMOVESPEFIC));
            return this;
        }
