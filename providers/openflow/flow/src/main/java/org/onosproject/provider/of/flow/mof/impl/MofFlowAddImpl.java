...
public class MofFlowAddImpl implements MofFlowMod{
    private static final Logger log = LoggerFactory.getLogger(MofFlowAddImpl.class);
    // version: 1.0
    ...
    MofFlowAddImpl(long xid, TrafficSelector selector, U64 cookie, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, Set<OFFlowModFlags> flags, TrafficTreatment treatment, TableId tableId) {
        ...
        if(cookie == null) {
            throw new NullPointerException("MofFlowAddImpl: property cookie cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("MofFlowAddImpl: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("MofFlowAddImpl: property outPort cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("MofFlowAddImpl: property flags cannot be null");
        }
        if(treatment == null) {
    ...
    static class Writer implements OFMessageWriter<MofFlowAddImpl> {
        @Override
        public void write(ByteBuf bb, MofFlowAddImpl message) {
    ...
    static class OFFlowAddVer10Funnel implements Funnel<MofFlowAddImpl> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(MofFlowAddImpl message, PrimitiveSink sink) {
        // fixed value property version = 1
    ...
    public boolean equalsIgnoreXid(Object obj) {
        ...
        return false;
        MofFlowAddImpl other = (MofFlowAddImpl) obj;
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("MofFlowAddImpl");
