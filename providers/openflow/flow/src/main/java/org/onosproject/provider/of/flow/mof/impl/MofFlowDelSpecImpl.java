...
public class MofFlowDelSpecImpl implements MofFlowMod{
    private static final Logger log = LoggerFactory.getLogger(MofFlowDelSpecImpl.class);
    // version: 1.0
    ...
    protected MofFlowDelSpecImpl(TrafficSelector selector, TrafficTreatment treatment){
    ...
    MofFlowDelSpecImpl(long xid, TrafficSelector selector, U64 cookie, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, Set<OFFlowModFlags> flags, TrafficTreatment treatment, TableId tableId) {
        if(selector == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property selector cannot be null");
        }
        if(cookie == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property cookie cannot be null");
        }
        if(bufferId == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property bufferId cannot be null");
        }
        if(outPort == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property outPort cannot be null");
        }
        if(flags == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property flags cannot be null");
        }
        if(treatment == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property treatment cannot be null");
        }
        if(tableId == null) {
            throw new NullPointerException("MofFlowDelSpecImpl: property tableId cannot be null");
        }
    ...
    public void writeTo(ByteBuf bb){
        log.info("MofFlowDelSpecImpl ready to write!!!");
        WRITER.write(bb, this);
    }

    final static Writer WRITER = new Writer();
    static class Writer implements OFMessageWriter<MofFlowDelSpecImpl> {
        @Override
        public void write(ByteBuf bb, MofFlowDelSpecImpl message) {
        ...
        log.info("Mof delete specific flow on tableId" + message.tableId);
        ...
        throw new IllegalArgumentException("MofFlowDelSpecImpl: message length (" + length + ") exceeds maximum (0xFFFF)");
        }
        bb.setShort(lengthIndex, length);
        log.info("MofFlowDelSpecImpl write done!!!");
    ...
    static class OFFlowAddVer10Funnel implements Funnel<MofFlowDelSpecImpl> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(MofFlowDelSpecImpl message, PrimitiveSink sink) {
        // fixed value property version = 1
    ...
    public boolean equalsIgnoreXid(Object obj) {
        ...
        return false;
        MofFlowDelSpecImpl other = (MofFlowDelSpecImpl) obj;
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("MofFlowDelSpecImpl");
