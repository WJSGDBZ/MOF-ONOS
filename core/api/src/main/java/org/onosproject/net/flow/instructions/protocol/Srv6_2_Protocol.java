...
public class Srv6_2_Protocol implements Protocol {
    ...
    public static int LEN = Srv6_TypeCriterion.LEN + Srv6_Hdr_Ext_LenCriterion.LEN + Srv6_Routing_TypeCriterion.LEN + Srv6_Segments_LeftCriterion.LEN + Srv6_Last_EntyCriterion.LEN + Srv6_FlagsCriterion.LEN + Srv6_TagCriterion.LEN + Srv6_Segmentlist1Criterion.LEN + Srv6_Segmentlist2Criterion.LEN;

    public Srv6_2_Protocol(Srv6_TypeCriterion srv6_type, Srv6_Hdr_Ext_LenCriterion srv6_hdr_ext_len, Srv6_Routing_TypeCriterion srv6_routing_Type, Srv6_Segments_LeftCriterion srv6_segments_left, Srv6_Last_EntyCriterion srv6_last_enty, Srv6_FlagsCriterion srv6_flags, Srv6_TagCriterion srv6_tag, Srv6_Segmentlist1Criterion srv6_segmentlist1, Srv6_Segmentlist2Criterion srv6_segmentlist2){
    ...
    public static Srv6_2_Protocol read(ByteBuf bb){
        ...
        bb.skipBytes(16);
        return new Srv6_2_Protocol(srv6_type, srv6_hdr_ext_len, srv6_routing_Type, srv6_segments_left, srv6_last_enty, srv6_flags, srv6_tag, srv6_segmentlist1, srv6_segmentlist2);
    }

    @Override
    public String toString() {
        return "Srv6_2_Protocol{ " + srv6_type + ", " + srv6_hdr_ext_len + ", " + srv6_routing_Type + ", " + srv6_segments_left + ", " + srv6_last_enty + ", " + srv6_flags + ", " + srv6_tag + ", " + srv6_segmentlist1 + ", " + srv6_segmentlist2 + " }";
    }

    @Override
    public int hashCode() {
        return Objects.hash(srv6_type, srv6_hdr_ext_len, srv6_routing_Type, srv6_segments_left, srv6_last_enty, srv6_flags, srv6_tag, srv6_segmentlist1, srv6_segmentlist2);
    }
