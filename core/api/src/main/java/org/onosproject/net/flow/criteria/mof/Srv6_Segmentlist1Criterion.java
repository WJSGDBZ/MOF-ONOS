...
public final class Srv6_Segmentlist1Criterion implements Criterion {
    ...
    public Srv6_Segmentlist1 value() {
        return srv6_segmentlist1;
    }
  
    public Srv6_Segmentlist1 mask(){
        return mask;
    }

    public Srv6_Segmentlist1Criterion(Srv6_Segmentlist1 srv6_segmentlist1) {
     ...
     */
    public Srv6_Segmentlist1Criterion(Srv6_Segmentlist1 srv6_segmentlist1, Srv6_Segmentlist1 mask) {
        this.srv6_segmentlist1 = srv6_segmentlist1;
      	this.mask = mask;
    }
    ...
    public static class Builder implements Criterion.Builder {
        ...
        public Builder setValid(boolean valid){
            ...
            if(valid){ 
                ...
                this.mask = Srv6_Segmentlist1.valueOf(ALL);
            }
            return this;
        }
