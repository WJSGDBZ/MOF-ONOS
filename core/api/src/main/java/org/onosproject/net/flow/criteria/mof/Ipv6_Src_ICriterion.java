...
public final class Ipv6_Src_ICriterion implements Criterion {
    ...
    public Ipv6_Src_I value() {
        return ipv6_src_i;
    }
  
    public Ipv6_Src_I mask(){
        return mask;
    }

    public Ipv6_Src_ICriterion(Ipv6_Src_I ipv6_src_i) {
     ...
     */
    public Ipv6_Src_ICriterion(Ipv6_Src_I ipv6_src_i, Ipv6_Src_I mask) {
        this.ipv6_src_i = ipv6_src_i;
      	this.mask = mask;
    }
    ...
    public static class Builder implements Criterion.Builder {
        ...
        public Builder setValid(boolean valid){
            ...
            if(valid){ 
                ...
                this.mask = Ipv6_Src_I.valueOf(ALL);
            }
            return this;
        }
