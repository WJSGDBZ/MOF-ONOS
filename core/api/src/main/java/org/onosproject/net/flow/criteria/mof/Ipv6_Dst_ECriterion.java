...
public final class Ipv6_Dst_ECriterion implements Criterion {
    ...
    public Ipv6_Dst_E value() {
        return ipv6_dst_e;
    }
  
    public Ipv6_Dst_E mask(){
        return mask;
    }

    public Ipv6_Dst_ECriterion(Ipv6_Dst_E ipv6_dst_e) {
     ...
     */
    public Ipv6_Dst_ECriterion(Ipv6_Dst_E ipv6_dst_e, Ipv6_Dst_E mask) {
        this.ipv6_dst_e = ipv6_dst_e;
      	this.mask = mask;
    }
    ...
    public static class Builder implements Criterion.Builder {
        ...
        public Builder setValid(boolean valid){
            ...
            if(valid){ 
                ...
                this.mask = Ipv6_Dst_E.valueOf(ALL);
            }
            return this;
        }
